...
Si el byte es 0, se envia una nueva apuesta
Si el byte es 1, se envia que se termino de enviar apuestas, y estamos esperando el sorteo

Desde el servidor, cuando se solicitan los ganadores, existen dos posibilidades tambien.
En el caso de que no todos los clientes hayan terminado sus apuestas, se devuelve el mensaje "NOT_READY"
En el caso de que todos ya hayan finalizado sus apuestas, se envian los strings que representan el numero de DNI de los ganadores de esa agencia, separados por ';'. 
Desde el servidor tambien se finalizan los mensajes con un \n
